<template>
  ...
  　<h2 id="基本信息">本博客</h2>
    <ul>
      <li>算是学习 <a href="http://cn.vuejs.org/">Vue</a> 来练手了</li>
      <li>简单的重构了之前 <a href="https://blog.hxtao.site/">Blog</a> 的前端页面</li>
      <li>未做优化处理</li>
      <li>写到最后突然想 <a href="http://koajs.com/">Koa</a> + Vue 重构前后端，　... RESTful API 配合 JWT ... <img src="https://oblky3j33.qnssl.com/images/11.gif" alt="">有搞头</li>
    </ul>
